...
#define KC_R_SCLN LT(L_FN, KC_SCLN) // tap: ;, 長押し: _RAI
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
    [L_RCTRL] = LAYOUT(
        RESET, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, CLEAR,
