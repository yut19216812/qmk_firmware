...
[_MAIN] = LAYOUT_60_ansi_split_space_rshift(
    KC_ESC_EN, KC_1,  KC_2,  KC_3,  KC_4,  KC_5,  KC_6,  KC_7,  KC_8,     KC_9,    KC_0,        KC_MINS,    KC_EQL,   KC_BSPC,
    KC_TAB,    KC_Q,  KC_W,  KC_E,  KC_R,  KC_T,  KC_Y,  KC_U,  KC_I,     KC_O,    KC_P,        KC_LBRC,    KC_RBRC,  KC_BSLASH,
    KC_LCTL,   KC_A,  KC_S,  KC_D,  KC_F,  KC_G,  KC_H,  KC_J,  KC_K,     KC_L,    KC_MV_SCLN,  KC_QUOT,    KC_ENT,
    KC_LSFT,   KC_Z,  KC_X,  KC_C,  KC_V,  KC_B,  KC_N,  KC_M,  KC_COMM,  KC_DOT,  KC_SLSH,     KC_ESC_EN,  MO(_MGR),
    KC_LCTL,   KC_LALT, KC_LGUI, M_SPC, KC_LSFT, M_ENT, KC_RGUI, KC_RALT, KC_RCTL, TG(_GAME)),

[_MGR] = LAYOUT_60_ansi_split_space_rshift(
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RESET,   KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),

[_MOVE] = LAYOUT_60_ansi_split_space_rshift(
...
[_SYMBOL] = LAYOUT_60_ansi_split_space_rshift(
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, KC_LANG2, KC_LANG1, KC_TRNS, KC_MINS, KC_EQL,  KC_LCBR, KC_RCBR, KC_PIPE, KC_GRV, KC_TRNS,
...
[_GAME] = LAYOUT_60_ansi_split_space_rshift(
    ...
    KC_LCTL,   KC_A,  KC_S,  KC_D,  KC_F,  KC_G,  KC_H,  KC_J,  KC_K,     KC_L,    KC_MV_SCLN,  KC_QUOT,    KC_ENT,
    KC_LSFT,   KC_Z,  KC_X,  KC_C,  KC_V,  KC_B,  KC_N,  KC_M,  KC_COMM,  KC_DOT,  KC_SLSH,     KC_ESC_EN,  MO(_MGR),
    KC_LCTL,   KC_LALT, KC_LGUI, KC_SPC, KC_LSFT, M_ENT, KC_RGUI, KC_RALT, KC_RCTL, KC_TRNS),
};
