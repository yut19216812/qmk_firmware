...
[_MAIN] = LAYOUT_60_b_ansi(
    ...
    KC_LCTL, KC_LALT, KC_LGUI, M_SPC, KC_LSFT, M_ENT, ALT_T(KC_BSPC), KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT),

[_MGR] = LAYOUT_60_b_ansi(
