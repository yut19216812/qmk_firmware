...
#define LT2_SCLN LT(_L2, KC_SCLN)
...
[_QW] = LAYOUT(
    ...
    KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    LT2_SCLN, KC_QUOT,
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ESC_EN,
    XXXXXXX, XXXXXXX, XXXXXXX, KC_LGUI, MO(_L1), SFT_SPC, SFT_ENT, LT1_BSPC, KC_RALT, XXXXXXX, XXXXXXX, XXXXXXX
  ),
...
[_L1] = LAYOUT(
    ...
    _______, _______, _______, KC_LGUI, MO(_L3), SFT_SPC, SFT_ENT, MO(_L3), KC_RALT, _______, _______, _______
  ),
...
[_L3] = LAYOUT(
    ...
    KC_TRNS, _______, _______, _______, _______, _______,  _______, _______, _______, _______, _______, _______,
    _______, _______, _______, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS, MO(_L4), _______, _______, _______
  ),
...
[_L4] = LAYOUT(
    ...
    _______, _______, _______, KC_LGUI, KC_SPC,  _______,  _______, KC_ENT, KC_RALT, _______, _______, _______
  ),
};
